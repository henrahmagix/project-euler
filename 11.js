...
grid.push([22, 31, 16, 71, 51, 67, 63, 89, 41, 92, 36, 54, 22, 40, 40, 28, 66, 33, 13, 8]);
grid.push([24, 47, 32, 60, 99, 3, 45, 2, 44, 75, 33, 53, 78, 36, 84, 20, 35, 17, 12, 5]);
grid.push([32, 98, 81, 28, 64, 23, 67, 10, 26, 38, 40, 67, 59, 54, 70, 66, 18, 38, 64, 7]);
...
grid.push([19, 80, 81, 68, 5, 94, 47, 69, 28, 73, 92, 13, 86, 52, 17, 77, 4, 89, 55, 4]);
...
// First, lets go left to right.
var x, y, line, current=[], product=0, temp;
// This is the outer loop, going down the y-axis.
for (y=0; y<20; y++) {
  // Now the x-axis, checking 4 at a time, so we stop at 16.
  for (x=0; x<16; x++) {
    current[0] = grid[y][x];
    current[1] = grid[y][x+1];
    current[2] = grid[y][x+2];
    current[3] = grid[y][x+3];
    temp = eval(current.join('*'));
...
for (x=0; x<20; x++) {
  for (y=0; y<16; y++) {
    current[0] = grid[y][x];
    current[1] = grid[y+1][x];
    current[2] = grid[y+2][x];
    current[3] = grid[y+3][x];
    temp = eval(current.join('*'));
    if (temp > product) product = temp;
  }
}

// Now diagonally, up-left to down-right. Like this: \
for (x=0; x<16; x++) {
  for (y=0; y<16; y++) {
    current[0] = grid[y][x];
    current[1] = grid[y+1][x+1];
    current[2] = grid[y+2][x+2];
    current[3] = grid[y+3][x+3];
    temp = eval(current.join('*'));
    if (temp > product) product = temp;
  }
}

// Now diagonally, up-right to down-left. Like this: /
for (x=4; x<20; x++) {
  for (y=0; y<16; y++) {
    current[0] = grid[y][x];
    current[1] = grid[y+1][x-1];
